...
export const userService = {
   ...
   * @returns Success message
   */
  verifyAccount: async (params: VerifyAccountParams) => {
    try {
   ...
   */
  updateUser: async (userId: string, params: UpdateUserParams): Promise<UserResponse> => {
    try {
   ...
   * @returns Success message
   */
  updatePassword: async (userId: string, params: UpdatePasswordParams) => {
    try {
